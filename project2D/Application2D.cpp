...
void Application2D::draw() {
 ...
 //   m_2dRenderer->drawSprite(m_texture, 200, 200, 100, 100);
	...
	m_2dRenderer->setUVRect(0, 0, 1, 1);
	m_2dRenderer->drawSprite(m_AsteroidTextureSmall, 1280 / 2, 680, 0, 0, 0, 1);

	m_2dRenderer->setUVRect(0, 0, 1, 1);
	m_2dRenderer->drawSprite(m_AsteroidTextureMedium, 1280 / 2 + 400, 680, 0, 0, 0, 1);

	m_2dRenderer->setUVRect(0, 0, 1, 1);
	m_2dRenderer->drawSprite(m_AsteroidTextureLarge, 1280 / 2 - 200, 680, 0, 0, 0, 1);

	// draw a thin line
	m_2dRenderer->drawLine(m_player->m_isShooting.m_x, m_player->m_isShooting.m_y, m_player->m_position.m_x, m_player->m_position.m_y, 2, 1);
...
bool Player::AddForce(Vector2 Force, float deltaTime)
{
